                ...
                <div className="offset-lg-1 offset-1 col-10 col-lg-5 fs-2 text-start my-4 mx-auto">
                    ...
                    <Accordion defaultActiveKey="0" id="educationAccordion">
                        <Accordion.Item eventKey="0">
                            ...
                            <Accordion.Body>
                                <div className="row">
                                    <p className="resume-title fw-bold fs-6 col-12">Anand Engineering College</p>
                                    <p className="resume-description col-12 my-1">
                                        I completed my B.Tech in Electronics and Communication Engineering from Anand Engineering College. Where I built a strong foundation in electronics, communication systems, and modern technologies in the field.
                                    </p>
                                </div>
                            </Accordion.Body>
                        </Accordion.Item>
                ...
                <div className="offset-lg-1 offset-1 col-10 col-lg-5 fs-2 text-start my-4 mx-auto">
                    ...
                    <Accordion defaultActiveKey="0" id="coursesAccordion">
                        <Accordion.Item eventKey="0">
                            ...
                            <Accordion.Body>
                                <div className="row">
                                    <h4 className="resume-title fw-bold col-7">Coding Ninjas <a href="https://ninjasfiles.s3.amazonaws.com/certificate278050899d3f9998a701805a910f73c2096d45d.pdf" className='bi bi-arrow-up-right-square-fill'></a></h4>
                                    <h5 className="col-5 resume-date text-end fs-6">6 Months</h5>
                                    <p className="resume-description col-12 my-1">
                        ...
                        <Accordion.Item eventKey="1">
                            ...
                            <Accordion.Body>
                                <div className="row">
                                    ...
                                    <p className="resume-description col-12 my-1">
                                        Completing a training program focused on UI development, gaining proficiency in key technologies including HTML, CSS, JavaScript, and front-end frameworks
                                    </p>
                                </div>
                            </Accordion.Body>
                        </Accordion.Item>
